...
class metaconfig:
    ...
    sub_dirs = [
        ...
        "logs/04.profiling_humann3.6_config",
        "logs/04.profiling_humann3.6_build_chocophlan_pangenome_db",
        "logs/04.profiling_humann3.6",
        "logs/04.profiling_humann3.6_postprocess",
        "logs/04.profiling_humann3.6_join",
        "logs/04.profiling_humann3.6_split_stratified",
