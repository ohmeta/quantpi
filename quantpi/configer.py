...
class metaconfig:
    ...
    sub_dirs = [
        ...
        "logs/04.profiling_kraken2_krona_report",
        "logs/04.profiling_kraken2_combine_kreport",
        "logs/04.profiling_kraken2_combine_kreport_mpa",
        "logs/04.profiling_kraken2_bracken",
        "logs/04.profiling_kraken2_bracken_merge",
        "logs/04.profiling_krakenuniq",
        "logs/04.profiling_krakenuniq_krona_report",
        "logs/04.profiling_krakenuniq_combine_kreport",
        "logs/04.profiling_krakenuniq_combine_kreport_mpa",
        "logs/04.profiling_krakenuniq_bracken",
        "logs/04.profiling_krakenuniq_bracken_merge",
        ...
        "logs/04.profiling_humann4_config",
        "logs/04.profiling_humann4_build_chocophlan_pangenome_db",
        "logs/04.profiling_humann4",
        "logs/04.profiling_humann4_postprocess",
        "logs/04.profiling_humann4_join",
        "logs/04.profiling_humann4_split_stratified",
