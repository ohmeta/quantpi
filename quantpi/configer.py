...
class metaconfig:
    ...
    sub_dirs = [
        ...
        "logs/03.profiling_bgi_soap",
        "logs/03.profiling_bgi_soap_merge",
        "logs/03.profiling_bowtie2",
        "logs/03.profiling_bowtie2_merge",
        ...
        "logs/03.profiling_bracken",
        "logs/03.profiling_bracken_merge",
