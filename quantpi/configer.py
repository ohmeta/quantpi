...
class metaconfig:
    ...
    sub_dirs = [
        ...
        "logs/04.profiling_bgi_soap",
        "logs/04.profiling_bgi_soap_merge",
        "logs/04.profiling_bowtie2",
        "logs/04.profiling_bowtie2_merge",
        ...
        "logs/04.profiling_jgi",
        "logs/04.profiling_jgi_merge",
